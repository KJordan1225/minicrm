...
<div class="login-container bg-white"
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200" id="top-projects-create">
                    ...
                    <form method="POST" action="{{ route('projects.store') }}">
                       ...
                       <!-- Title Input -->
						...
						<div class="mb-4 w-50">
							...
							<input type="date" class="form-control" id="deadline_at" name="deadline_at" min="{{ today()->format('Y-m-d') }}" value="" />
    ...
    <script>
        ...
        document.getElementById('top-projects-create').scrollIntoView({ behavior: 'smooth' });
        };
    </script>
</x-app-layout>