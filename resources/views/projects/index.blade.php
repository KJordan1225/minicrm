...
<div class="login-container bg-white"
        style="margin-top: 3%; max-width: 900px; margin-bottom: 3%;">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <table class="table" id="top-projects-index">
                        <thead>
                        <tr>
                        ...
                        @foreach($projects as $project)
                            <tr class="bg-white">
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
                                    {{ $project->user->first_name ?? 'first name' }} {{ $project->user->last_name ?? 'last name'}}
                                </td>
                                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-900">
    ...
    <script>
        ...
        document.getElementById('top-projects-index').scrollIntoView({ behavior: 'smooth' });
        };
    </script>
</x-app-layout>